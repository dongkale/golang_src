...
type TeamCommentListController struct {
	beego.Controller
}

func (c *TeamCommentListController) Post() {
	...
	rtnRecruitApplyCommentList := models.RtnRecruitApplyCommentList{}
	...
	c.Data["json"] = &rtnRecruitApplyCommentList
	c.ServeJSON()
}
